    ...
    <div className="bg-gradient-to-br from-primary-800 to-primary-900 rounded-2xl shadow-xl p-6 sticky top-4">
      ...
      {user ? (
        ...
        <div className="text-center py-8">
          ...
          <button className="w-full py-3 bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-400 hover:to-gold-500 text-primary-900 font-semibold rounded-xl transition-all duration-200">
            Login / Register
          </button>
        </div>
      )}
